...
<%@ include file="header.html"%>
    <form action="dataToDB.jsp">
        <div class="container">
            <h1>ADD STOCK</h1>
            <div id="fert">
                <select name="fname"  id="itemName" tabindex="1" class="form-control" onchange="getPrice()">
                    ...
                    <%
				        ...
				        while(rs.next())
				        {%>
				        	<option  value = "<%=rs.getString("name")%>" label="<%=rs.getString("name")%>"><%=rs.getString("name")%></option>
