function getValues(){
    ...
    let  qty = document.getElementById("qty").value;
     ...
     let total = (price*qty);
     content = '<tr id="addItems"><td class="items">'+item+'</td><td class="price">'+price+'</td><td class="qnty">'+qty+'</td><td class="desc">'+total.toFixed(2)+'</td><td class="desc"><input type="button" value="DeleteItem" onclick="deleteItem('+sl+')"></td></tr>';
